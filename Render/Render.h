...
public:
    ...
    void SetMeshMixSkinAnimRot(const int id, const D3DXVECTOR3& rotate);
    ...
    void SetPostEffectDepthBufferShadowBiasFar(const float shadowBias);
    ...
    float GetPostEffectDepthBufferShadowBiasFar() const;
...
private:
    ...
    float m_postEffectBloomThreshold = 0.95f;
    float m_postEffectBloomWeightSum = 0.1f;
    float m_postEffectHaloThreshold = 1.5f;
