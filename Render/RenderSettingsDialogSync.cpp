...

{
    ...
    SetSettingsEditFloat(hWnd, 41011, state->gBufferFarPlane, L"%.1f");


    SetSettingsEditFloat(hWnd, 41100, render->GetLightBrightness(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41101, render->GetAmbientLightBrightness(), L"%.1f");
    ...
    SetTrackbarFromFloat(hWnd, 31102, render->GetMeshMixSaturateShadowIntensity(), 0.0f, 4.0f);

    SetTrackbarFromFloat(hWnd, 31103, render->GetMeshMixShadowDarkness(), 0.0f, 1.0f);

    SetTrackbarFromFloat(hWnd, 31104, render->GetMeshMixSpecularIntensity(), 0.0f, 1.0f);
    ...
    SetTrackbarFromFloat(hWnd, 31107, render->GetMeshMixSSSIntensity(), 0.0f, 2.0f);

    SetTrackbarFromFloat(hWnd, 31124, render->GetMeshMixFresnelIntensity(), 0.0f, 1.0f);
    ...
    SetTrackbarFromFloat(hWnd, 31500, render->GetMeshPBRRoughness(), 0.0f, 1.0f);

    SetTrackbarFromFloat(hWnd, 31501, render->GetMeshPBRMetallic(), 0.0f, 1.0f);

    SetTrackbarFromFloat(hWnd, 31502, render->GetMeshPBREnvReflectionIntensity(), 0.0f, 1.0f);

    SetTrackbarFromFloat(hWnd, 31503, render->GetMeshPBREnvMaxMipLevel(), 0.0f, 10.0f);

    SetTrackbarFromFloat(hWnd, 31504, render->GetMeshPBREnvDiffuseIntensity(), 0.0f, 1.0f);
    ...
    SetTrackbarFromFloat(hWnd, 31800, render->GetPostEffectSSAOSampleRadius(), 0.1f, 10.0f);

    SetTrackbarFromFloat(hWnd, 31803, render->GetPostEffectSSAOShadowStrength(), 0.0f, 2.0f);

    SetTrackbarFromFloat(hWnd, 31804, render->GetPostEffectSSAOSaturationBoost(), 0.0f, 2.0f);
    ...
    SetSettingsEditFloat(hWnd, 41900, render->GetPostEffectFogIntensity(), L"%.1f");
    ...
    SetTrackbarFromFloat(hWnd, 31900, render->GetPostEffectFogIntensity(), 0.0f, 2.0f);
    ...
    SetSettingsEditFloat(hWnd, 41921, render->GetPostEffectHeightFogStart(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41922, render->GetPostEffectHeightFogMax(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41923, render->GetPostEffectHeightFogDistanceStart(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41924, render->GetPostEffectHeightFogDistanceMax(), L"%.1f");

    SetTrackbarFromFloat(hWnd, 31920, render->GetPostEffectHeightFogIntensity(), 0.0f, 2.0f);

    SetTrackbarFromFloat(hWnd, 31921, render->GetPostEffectHeightFogStart(), -20.0f, 20.0f);

    SetTrackbarFromFloat(hWnd, 31922, render->GetPostEffectHeightFogMax(), -20.0f, 20.0f);

    SetTrackbarFromFloat(hWnd, 31923, render->GetPostEffectHeightFogDistanceStart(), 0.0f, 100.0f);

    SetTrackbarFromFloat(hWnd, 31924, render->GetPostEffectHeightFogDistanceMax(), 0.0f, 100.0f);


    SetSettingsEditFloat(hWnd, 41940, render->GetPostEffectSaturate(), L"%.1f");

    SetTrackbarFromFloat(hWnd, 31940, render->GetPostEffectSaturate(), 0.0f, 2.0f);

    SetSettingsEditFloat(hWnd, 41950, render->GetPostEffectDepthOfFieldFocalDistance(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41951, render->GetPostEffectDepthOfFieldMaxBlurDistance(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41952, render->GetPostEffectDepthOfFieldAutoActivationDistance(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41953, render->GetPostEffectDepthOfFieldStartNear(), L"%.1f");

    SetTrackbarFromFloat(hWnd, 31950, render->GetPostEffectDepthOfFieldFocalDistance(), 0.0f, 20.0f);

    SetTrackbarFromFloat(hWnd, 31951, render->GetPostEffectDepthOfFieldMaxBlurDistance(), 0.0f, 32.0f);

    SetTrackbarFromFloat(hWnd, 31952, render->GetPostEffectDepthOfFieldAutoActivationDistance(), 0.0f, 20.0f);

    SetTrackbarFromFloat(hWnd, 31953, render->GetPostEffectDepthOfFieldStartNear(), 0.0f, 20.0f);


    SetSettingsEditFloat(hWnd, 41970, render->GetPostEffectBloomThreshold(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41971, render->GetPostEffectBloomWeightSum(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41972, render->GetPostEffectHaloThreshold(), L"%.1f");

    SetSettingsEditFloat(hWnd, 41980, render->GetPostEffectStarBurstThreshold(), L"%.1f");
    ...
    SetTrackbarFromFloat(hWnd, 31971, render->GetPostEffectBloomWeightSum(), 0.0f, 4.0f);
    ...
    SetSettingsEditFloat(hWnd, 42005, state->godRayPos.x, L"%.1f");

    SetSettingsEditFloat(hWnd, 42006, state->godRayPos.y, L"%.1f");

    SetSettingsEditFloat(hWnd, 42007, state->godRayPos.z, L"%.1f");
    ...
    SetTrackbarFromFloat(hWnd, 32003, render->GetPostEffectGodRayIntensity(), 0.0f, 1.0f);

    SetTrackbarFromFloat(hWnd, 32004, render->GetPostEffectGodRayVirtualProximityStrength(), 0.0f, 4.0f);

    SetTrackbarFromFloat(hWnd, 32005, state->godRayPos.x, -2000.0f, 2000.0f);

    SetTrackbarFromFloat(hWnd, 32006, state->godRayPos.y, -2000.0f, 2000.0f);

    SetTrackbarFromFloat(hWnd, 32007, state->godRayPos.z, -2000.0f, 2000.0f);
    ...
    SetTrackbarFromInt(hWnd, 32111, render->GetPostEffectMotionBlurCameraSampleCount(), 1, 32);
