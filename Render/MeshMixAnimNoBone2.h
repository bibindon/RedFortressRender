...
class MeshMixAnimNoBone2 : public IMeshMixSkinAnim
{
public:
...
private:
    ...
    HRESULT LoadMeshHierarchy(const std::wstring& filePath,
                               ...
                               CustomXLoader2::CustomXLoadPurpose loadPurpose = CustomXLoader2::CustomXLoadPurpose::MeshAndAnimation);
    ...
    MeshMixSkinAnimLoadMode m_loadMode = MeshMixSkinAnimLoadMode::Blender512Custom;
