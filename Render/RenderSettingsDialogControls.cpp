...
void InitializeRenderSettingsControls(HWND hWnd, RenderSettingsDialogState* state)
{
    ...
    CreateSettingsCheckbox(hWnd, IDC_RENDER_SETTINGS_DEBUG_WORLD_POS, L"F3 WorldPos", 22, y + 62, 104, 22);
    CreateSettingsCheckbox(hWnd, IDC_RENDER_SETTINGS_DEBUG_NORMAL, L"F4 Normal", 132, y + 62, 94, 22);
    CreateSettingsCheckbox(hWnd, IDC_RENDER_SETTINGS_DEBUG_DEPTH, L"F5 Depth", 232, y + 62, 88, 22);
    CreateSettingsCheckbox(hWnd, IDC_RENDER_SETTINGS_DEBUG_THICKNESS, L"F6 Thickness", 326, y + 62, 112, 22);
    CreateSettingsCheckbox(hWnd, IDC_RENDER_SETTINGS_DEBUG_BACK_DEPTH, L"F7 Back Depth", 22, y + 84, 120, 22);
    y += 118;
    ...
    CreateSettingsTrackbar(hWnd, 31970, 168, y + 16, 122, 30, 0, 100, 19);
    CreateSettingsEdit(hWnd, L"0.950", 298, y + 18, 40, 20, 41970);
    CreateSettingsStatic(hWnd, L"Sum", 350, y + 22, 34, 18);
    CreateSettingsTrackbar(hWnd, 31971, 386, y + 16, 58, 30, 0, 100, 10);
    CreateSettingsEdit(hWnd, L"0.100", 458, y + 18, 46, 20, 41971);
    CreateSettingsStatic(hWnd, L"Halo Threshold", 24, y + 42, 138, 18);
    CreateSettingsTrackbar(hWnd, 31972, 168, y + 36, 122, 30, 0, 100, 30);
    CreateSettingsEdit(hWnd, L"1.500", 298, y + 38, 40, 20, 41972);
    y += 70;
    CreateSettingsGroupBox(hWnd, L"StarBurst", 8, y, 504, 68);
    CreateSettingsStatic(hWnd, L"StarBurst Threshold", 24, y + 22, 138, 18);
    CreateSettingsTrackbar(hWnd, 31980, 168, y + 16, 122, 30, 0, 100, 18);
    CreateSettingsEdit(hWnd, L"0.900", 298, y + 18, 40, 20, 41980);
    CreateSettingsStatic(hWnd, L"StarBurst Dist Fade", 24, y + 44, 138, 18);
    CreateSettingsTrackbar(hWnd, 31981, 168, y + 38, 122, 30, 0, 100, 0);
    ...
    SendMessage(particleCombo, CB_ADDSTRING, 0, reinterpret_cast<LPARAM>(L"Damage"));
