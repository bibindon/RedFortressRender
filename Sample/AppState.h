...
constexpr float BLOOM_WEIGHT_SUM_MIN = 1.0f;
constexpr float BLOOM_WEIGHT_SUM_MAX = 100.0f;
constexpr float BLOOM_WEIGHT_SUM_STEP = 1.0f;
constexpr float HALO_THRESHOLD_MIN = 0.0f;
constexpr float HALO_THRESHOLD_MAX = 5.0f;
constexpr float HALO_THRESHOLD_STEP = 0.1f;
