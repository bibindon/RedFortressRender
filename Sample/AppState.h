...
int SSAOSampleCountToSliderValue(int sampleCount);
int SliderValueToSSAOSampleCount(int sliderValue);
int SSAOSampleRadiusToSliderValue(float sampleRadius);
float SliderValueToSSAOSampleRadius(int sliderValue);
int SSAOBlurKernelSizeToSliderValue(int kernelSize);
int SliderValueToSSAOBlurKernelSize(int sliderValue);
