...
constexpr float FOG_COLOR_MIN = 0.0f;
constexpr float FOG_COLOR_MAX = 1.0f;
constexpr float FOG_COLOR_STEP = 0.05f;
...
constexpr float HEIGHT_FOG_HEIGHT_MIN = -50000.0f;
constexpr float HEIGHT_FOG_HEIGHT_MAX = 50000.0f;
constexpr float HEIGHT_FOG_HEIGHT_STEP = 0.5f;
constexpr float HEIGHT_FOG_DISTANCE_MIN = 0.0f;
constexpr float HEIGHT_FOG_DISTANCE_MAX = 100000.0f;
...
constexpr float SSAO_SHADOW_STRENGTH_MIN = 0.0f;
constexpr float SSAO_SHADOW_STRENGTH_MAX = 4.0f;
constexpr float SSAO_SHADOW_STRENGTH_STEP = 0.05f;
constexpr float SSAO_SHADOW_SATURATION_BOOST_MIN = 0.0f;
constexpr float SSAO_SHADOW_SATURATION_BOOST_MAX = 5.0f;
constexpr float SSAO_SHADOW_SATURATION_BOOST_STEP = 0.05f;
constexpr int SSAO_SAMPLE_COUNT_MIN = 1;
constexpr int SSAO_SAMPLE_COUNT_MAX = 64;
...
constexpr int SSAO_BLUR_KERNEL_SIZE_MIN = 3;
constexpr int SSAO_BLUR_KERNEL_SIZE_MAX = 21;
constexpr int SSGI_SAMPLE_COUNT_MIN = 1;
constexpr int SSGI_SAMPLE_COUNT_MAX = 64;
constexpr int SSGI_BLUR_KERNEL_SIZE_MIN = 5;
constexpr int SSGI_BLUR_KERNEL_SIZE_MAX = 21;
constexpr float SSGI_SAMPLE_RADIUS_MIN = 0.1f;
constexpr float SSGI_SAMPLE_RADIUS_MAX = 10.0f;
constexpr float SSGI_SAMPLE_RADIUS_STEP = 0.1f;
...
constexpr float DOF_START_NEAR_MIN = 0.0f;
constexpr float DOF_START_NEAR_MAX = 50.0f;
constexpr float DOF_START_NEAR_STEP = 0.1f;
...
constexpr int FONTEX_GAUSSIAN_SAMPLE_MIN = 1;
constexpr int FONTEX_GAUSSIAN_SAMPLE_MAX = 21;
...
extern bool g_bSSAO;
extern bool g_bSSGI;
extern bool g_bSSAOBlur;
extern bool g_bSSGIBlur;
extern bool g_bSSAODepthScaledSampleDistance;
extern bool g_bFog;
...
extern float g_ssaoShadowStrength;
extern float g_ssaoShadowSaturationBoost;
extern int g_ssaoSampleCount;
extern float g_ssaoSampleRadius;
extern int g_ssaoBlurKernelSize;
extern int g_ssgiSampleCount;
extern int g_ssgiBlurKernelSize;
extern float g_ssgiSampleRadius;
extern float g_ssgiIndirectLightStrength;
extern float g_ssgiIndirectLightMaxContribution;
...
extern int g_fontExGaussianSampleSize;
...
extern int g_ssaoTexSizeDivisor;
extern bool g_bSSAOCompositeGaussian3x3;
extern int g_sunId;
...
int FogColorToSliderValue(float value);
float SliderValueToFogColor(int sliderValue);
...
int ShadowTapCountToComboIndex(int tapCount);
int ComboIndexToShadowTapCount(int comboIndex);
int SSAOShadowStrengthToSliderValue(float shadowStrength);
float SliderValueToSSAOShadowStrength(int sliderValue);
int SSAOShadowSaturationBoostToSliderValue(float boost);
float SliderValueToSSAOShadowSaturationBoost(int sliderValue);
int SSAOSampleCountToComboIndex(int sampleCount);
int ComboIndexToSSAOSampleCount(int comboIndex);
int SSAOSampleRadiusToSliderValue(float sampleRadius);
float SliderValueToSSAOSampleRadius(int sliderValue);
int SSAOBlurKernelSizeToComboIndex(int kernelSize);
int ComboIndexToSSAOBlurKernelSize(int comboIndex);
int SSGISampleCountToComboIndex(int sampleCount);
int ComboIndexToSSGISampleCount(int comboIndex);
int SSGISampleRadiusToSliderValue(float sampleRadius);
float SliderValueToSSGISampleRadius(int sliderValue);
int SSGIBlurKernelSizeToComboIndex(int kernelSize);
int ComboIndexToSSGIBlurKernelSize(int comboIndex);
...
int DepthOfFieldStartNearToSliderValue(float distance);
float SliderValueToDepthOfFieldStartNear(int sliderValue);
...
int FontExGaussianSampleSizeToSliderValue(int sampleSize);
int SliderValueToFontExGaussianSampleSize(int sliderValue);
