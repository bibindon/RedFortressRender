...
constexpr float CAMERA_FAR_MAX = 33000.0f;
constexpr float CAMERA_SHAKE_DURATION_MIN = 0.1f;
constexpr float CAMERA_SHAKE_DURATION_MAX = 5.0f;
constexpr float CAMERA_SHAKE_DURATION_STEP = 0.1f;
constexpr float CAMERA_SHAKE_INTENSITY_MIN = 0.0f;
constexpr float CAMERA_SHAKE_INTENSITY_MAX = 1.0f;
constexpr float CAMERA_SHAKE_INTENSITY_STEP = 0.01f;
constexpr float GBUFFER_NEAR_MIN = 0.01f;
constexpr float GBUFFER_NEAR_MAX = 1000.0f;
constexpr float GBUFFER_FAR_MIN = 1.0f;
constexpr float GBUFFER_FAR_MAX = 33000.0f;
...
constexpr float FRESNEL_INTENSITY_MIN = 0.0f;
constexpr float FRESNEL_INTENSITY_MAX = 2.0f;
constexpr float FRESNEL_INTENSITY_STEP = 0.05f;
constexpr float ENV_MAP_BLEND_MIN = 0.0f;
constexpr float ENV_MAP_BLEND_MAX = 1.0f;
constexpr float ENV_MAP_BLEND_STEP = 0.05f;
constexpr float TAA_HISTORY_WEIGHT_MIN = 0.0f;
constexpr float TAA_HISTORY_WEIGHT_MAX = 1.0f;
constexpr float TAA_HISTORY_WEIGHT_STEP = 0.01f;
constexpr float PBR_ROUGHNESS_MIN = 0.04f;
constexpr float PBR_ROUGHNESS_MAX = 1.0f;
constexpr float PBR_ROUGHNESS_STEP = 0.01f;
constexpr float PBR_METALLIC_MIN = 0.0f;
constexpr float PBR_METALLIC_MAX = 1.0f;
constexpr float PBR_METALLIC_STEP = 0.01f;
constexpr float PBR_ENV_REFLECTION_INTENSITY_MIN = 0.0f;
constexpr float PBR_ENV_REFLECTION_INTENSITY_MAX = 3.0f;
constexpr float PBR_ENV_REFLECTION_INTENSITY_STEP = 0.05f;
constexpr float PBR_ENV_MAX_MIP_LEVEL_MIN = 0.0f;
constexpr float PBR_ENV_MAX_MIP_LEVEL_MAX = 10.0f;
constexpr float PBR_ENV_MAX_MIP_LEVEL_STEP = 0.1f;
constexpr float PBR_ENV_DIFFUSE_INTENSITY_MIN = 0.0f;
constexpr float PBR_ENV_DIFFUSE_INTENSITY_MAX = 3.0f;
constexpr float PBR_ENV_DIFFUSE_INTENSITY_STEP = 0.05f;
constexpr float PBR_ENV_DIFFUSE_MIP_LEVEL_MIN = 0.0f;
constexpr float PBR_ENV_DIFFUSE_MIP_LEVEL_MAX = 10.0f;
constexpr float PBR_ENV_DIFFUSE_MIP_LEVEL_STEP = 0.1f;
...
constexpr float BLOOM_THRESHOLD_STEP = 0.05f;
constexpr float BLOOM_WEIGHT_SUM_MIN = 0.0f;
constexpr float BLOOM_WEIGHT_SUM_MAX = 1.0f;
constexpr float BLOOM_WEIGHT_SUM_STEP = 0.01f;
constexpr float HALO_THRESHOLD_MIN = 0.0f;
constexpr float HALO_THRESHOLD_MAX = 5.0f;
constexpr float HALO_THRESHOLD_STEP = 0.05f;
...
constexpr float STARBURST_THRESHOLD_STEP = 0.05f;
constexpr float STARBURST_DISTANCE_FADE_MIN = 0.0f;
constexpr float STARBURST_DISTANCE_FADE_MAX = 1.0f;
constexpr float STARBURST_DISTANCE_FADE_STEP = 0.05f;
...
constexpr float POINT_LIGHT_BRIGHTNESS_MAX = 100.0f;
...
constexpr float GAUSSIAN_STRENGTH_MIN = 0.0f;
constexpr float GAUSSIAN_STRENGTH_MAX = 1.0f;
constexpr float GAUSSIAN_STRENGTH_STEP = 0.01f;
...
extern bool g_bMeshMixSkinAnimAlphaClip;
...
extern bool g_bFXAA;
extern bool g_bTAA;
extern float g_taaHistoryWeight;
...
extern bool g_bSSAOSeparableBlur;
extern bool g_bSSGIBlur;
extern bool g_bSSGISeparableBlur;
extern bool g_bSSAORandomSamplingDirection;
extern bool g_bSSAODepthScaledSampleDistance;
extern bool g_bSSAOMaxDarknessClamp;
extern bool g_bFog;
...
extern float g_cameraShakeDurationSeconds;
extern float g_cameraShakeIntensity;
...
extern float g_fresnelIntensity;
extern float g_envMapBlend;
extern float g_pbrRoughness;
extern float g_pbrMetallic;
extern float g_pbrEnvReflectionIntensity;
extern float g_pbrEnvMaxMipLevel;
extern float g_pbrEnvDiffuseIntensity;
extern float g_pbrEnvDiffuseMipLevel;
extern bool g_bUseSpecularIntensityOverride;
extern bool g_bUseSpecularEdgeOverride;
extern bool g_bPhongTreatTextureAsWhite;
extern bool g_bSSS;
extern float g_sssIntensity;
extern D3DXCOLOR g_sssColor;
extern float g_bloomThreshold;
extern float g_bloomWeightSum;
extern float g_haloThreshold;
...
extern float g_starBurstDistanceFade;
...
extern float g_gaussianStrength;
...
int CameraShakeDurationToSliderValue(float durationSeconds);
float SliderValueToCameraShakeDuration(int sliderValue);
int CameraShakeIntensityToSliderValue(float intensity);
float SliderValueToCameraShakeIntensity(int sliderValue);
...
int FresnelIntensityToSliderValue(float intensity);
float SliderValueToFresnelIntensity(int sliderValue);
int EnvMapBlendToSliderValue(float blend);
float SliderValueToEnvMapBlend(int sliderValue);
int TAAHistoryWeightToSliderValue(float historyWeight);
float SliderValueToTAAHistoryWeight(int sliderValue);
int PBRRoughnessToSliderValue(float roughness);
float SliderValueToPBRRoughness(int sliderValue);
int PBRMetallicToSliderValue(float metallic);
float SliderValueToPBRMetallic(int sliderValue);
int PBREnvReflectionIntensityToSliderValue(float intensity);
float SliderValueToPBREnvReflectionIntensity(int sliderValue);
int PBREnvMaxMipLevelToSliderValue(float mipLevel);
float SliderValueToPBREnvMaxMipLevel(int sliderValue);
int PBREnvDiffuseIntensityToSliderValue(float intensity);
float SliderValueToPBREnvDiffuseIntensity(int sliderValue);
int PBREnvDiffuseMipLevelToSliderValue(float mipLevel);
float SliderValueToPBREnvDiffuseMipLevel(int sliderValue);
...
int BloomWeightSumToSliderValue(float weightSum);
float SliderValueToBloomWeightSum(int sliderValue);
int HaloThresholdToSliderValue(float threshold);
float SliderValueToHaloThreshold(int sliderValue);
...
int StarBurstDistanceFadeToSliderValue(float fade);
float SliderValueToStarBurstDistanceFade(int sliderValue);
...
int GaussianStrengthToSliderValue(float strength);
float SliderValueToGaussianStrength(int sliderValue);
